   ...
   if($_SESSION['LOGIN_ROLE'] == 1){
	...
	if (count($resadminUser) == 0) {	
		...
		foreach($resadminUser as $rowadminUser ){		
			...
			$action = '<a href="businessAdd.php?id='.MyEncoder($rowadminUser['fld_id']).'" class="btn btn-icon-circle btn-nblue"><i class="fa fa-pencil"></i></a>';
			...
			$nestedData[] = $rowadminUser['fld_bLanguage'];
			$nestedData[] = $rowadminUser['fld_bName'];
			$nestedData[] = "<img src='http://45.114.245.106/neevNav/upload/business/".$rowadminUser['fld_bThumb']."'/>";
