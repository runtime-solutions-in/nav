                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h4 class="box-title">Manage Videos</h4>
                                <h6 class="box-subtitle">List of products uploaded by NEEV</h6>
                                <span class="box-controls pull-right">
                                    <a href="videoAdd.php" class="btn btn-md btn-nblue btn-block my-10">
                                        <i class="ti-plus"></i> Add New Video
                                    </a>
                                </span>
                            </div>
                            <div class="box-body">
