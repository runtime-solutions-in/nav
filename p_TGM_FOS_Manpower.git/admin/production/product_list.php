                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                ...
                                <span class="box-controls pull-right">
                                    <a href="productAdd.php" class="btn btn-md btn-nblue btn-block my-10">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="form-group ml-15">
                                        ...
                                        <div class="controls">
                                            <select name="select" id="region-list" class="form-control" aria-invalid="false">
