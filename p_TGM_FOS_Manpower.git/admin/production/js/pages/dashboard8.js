...
$(document).ready(function() {
   var sparklineLogin = function() { 
        ...
        $("#sparkline7").sparkline([2,4,4,6,8,5,6,4,8,6,6,2 ], {
            type: 'line',
            width: '100%',
            height: '45',
            lineColor: '#ba69aa',
...
$(document).ready(function() {
   var sparklineLogin = function() { 
        ...
        $("#sparkline6").sparkline([2,4,4,6,8,5,6,4,8,6,6,2 ], {
            type: 'line',
            width: '100%',
            height: '45',
            lineColor: '#ba69aa',
...
// Morris-chart
	...
	Morris.Area({
        ...
        pointSize: 0,
        fillOpacity: 1,
        pointStrokeColors:['#05b085', '#69cce0'],
        behaveLikeLine: true,
        gridLineColor: '#e0e0e0',
        lineWidth: 0,
        smooth: false,
        hideHover: 'auto',
        lineColors: ['#05b085', '#69cce0'],
        resize: true
