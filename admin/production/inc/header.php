 <header class="main-header">
          ...
          -->
                <!-- logo -->
                <div class="logo-lg">
                    <span class="light-logo"><img src="../images/tata-white.png" alt="logo" /></span>
                    <span class="dark-logo"><img src="../images/tataBlue.png" alt="logo" /></span>
                </div>
            </a>
            <!-- Header Navbar -->
              ...
              -->
                            ...
                            <ul class="dropdown-menu animated flipInY">
                                ...
                                <li class="user-body">
                                    <a class="dropdown-item" href="javascript:void(0)"><i class="ion ion-person"></i>
                                        My Profile</a>
                                    <a class="dropdown-item" href="javascript:void(0)"><i class="ion ion-calendar"></i>
                                        My Events</a>
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <div class="p-10">
                                        <a href="javascript:void(0)" class="btn btn-sm btn-rounded btn-success">View
                                            Profile</a>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <li class="dropdown notifications-menu">
                            ...
                            <ul class="dropdown-menu animated fadeInDown">
                                <li class="header">
                                    <div class="bg-img text-white p-20" style="background-image: url(../images/user-info.jpg)"
                                        data-overlay="5">
                                        <div class="flexbox">
                                            <div>
                                                <h3 class="mb-0 mt-0">7 New</h3>
                                                <span class="font-light">Birthday Notifications</span>
                                            </div>
                                ...
                                <li>
                                    ...
                                    <ul class="menu sm-scrol">
                                        <li>
                                            <a href="#">
                                                <i class="fa fa-users text-info"></i> Curabitur id
                                ...
                                <li class="footer">
                                    <a href="#" class="text-white bg-danger">View all</a>
                                </li>
                            </ul>
                        </li>
                        <!-- Notices -->
                        <li class="dropdown tasks-menu">
                            ...
                            <ul class="dropdown-menu animated fadeInDown">
                                    ...
                                    <div class="bg-img text-white p-20" style="background-image: url(../images/user-info.jpg)"
                                        ...
                                        <div class="flexbox">
                                            <div>
                                                ...
                                                <span class="font-light">Notices</span>
                                            </div>
                                            <div class="font-size-40">
                                                <i class="mdi mdi-bulletin-board"></i>
                                            </div>
                                ...
                                <li class="footer">
                                    <a href="#" class="text-white bg-warning">View all tasks</a>
                                </li>
                            </ul>
                        </li>
