   ...
   if($_SESSION['LOGIN_ROLE'] == 1){
	...
	if (count($resadminUser) == 0) {	
		...
		foreach($resadminUser as $rowadminUser ){		
			...
			/*$action = '<a href="usermanagAdd.php?id='.MyEncoder($rowadminUser['fld_id']).'" class="btn btn-icon-circle btn-nblue"><i class="fa fa-pencil"></i></a>';
			...
			$nestedData[] = $rowadminUser['fld_accountName'];
			$nestedData[] = 'TSM';
			$nestedData[] = 'TGM';
			$nestedData[] = $rowadminUser['fld_phoneNo'];
			$nestedData[] = $rowadminUser['fld_state'];//$rowadminUser['fld_state'];
