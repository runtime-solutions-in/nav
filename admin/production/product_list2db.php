   ...
   if($_SESSION['LOGIN_ROLE'] == 1){
	...
	if (count($resadminUser) == 0) {	
		...
		foreach($resadminUser as $rowadminUser ){		
			...
			$action = '<a href="productAdd.php?id='.MyEncoder($rowadminUser['fld_id']).'" class="btn btn-icon-circle btn-nblue"><i class="fa fa-pencil"></i></a>';
			...
			$nestedData[] = "<img src='http://45.114.245.106/neevNav/upload/photo/".$rowadminUser['fld_productthumb']."' width='120' height='120'/>";
			$nestedData[] = $rowadminUser['fld_productname'];
			$nestedData[] = $rowadminUser['fld_categoryName'];
