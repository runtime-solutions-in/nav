<?php
	...
	$db2File = 'productmang_list2db.php';
	$table = '__product';
	//echo '<pre>';
	//print_r($_SESSION);
?>	
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                ...
                                <span class="box-controls pull-right">
                                    <a href="productmangAdd.php" class="btn btn-md btn-nblue btn-block my-10">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="form-group ml-15">
                                        ...
                                        <div class="controls">
                                            <select name="select" id="region-list" required="" class="form-control" aria-invalid="false" onchange="getval(this);">
                                ...
                                <div class="table-responsive">
                                    <table id="datatable-responsive" class="table table-hover no-wrap product-order" data-page-size="10">
                                        <thead>
